...
int main() {
	...
	while (op) {
		...
		printf("\t******************************************************************************\n");
		printf("\t\t\t1.  CreateGraph 创建              2.  DestroyGraph销毁\n");
		printf("\t\t\t3.  LocateVex   查找              4.  PutVex顶点赋值\n");
		printf("\t\t\t5.  FirstAdjVex 第一临接点        6.  NextAdjVex下一邻接点\n");
		printf("\t\t\t7.  InsertVex   插入顶点          8.  DeleteVex删除\n");
		printf("\t\t\t9.  InsertArc   插入弧            10. DeleteArc删除\n");
		printf("\t\t\t11. DFSTraverse 深度              12. BFSTraverse广度\n");
		printf("\t\t\t13. SaveGraph   存                14. LoadGraph取\n");
		printf("\t\t\t15. VerticesSetLessThanK  距离小于k的顶点集合    16. ShortestPathLength顶点间最短路径和长度\n");
		printf("\t\t\t17. ConnectedComponentsNums 图的连通分量个数     18. choose\n");
		printf("\t\t\t0.Exit   \n");
		printf("\t****************************************************************************\n");
		printf("\t\t\t请选择你的操作[0-18]: ");
		scanf("%d", &op);
