...
int main() {
	...
	while (op) {
		...
		printf("\t**************************************************************************\n");
		printf("\t**\t\t1.  InitBiTree初始化          2.  CreateBiTree创建 \t\t\n");
		printf("\t**\t\t3.  DestroyBiTree销毁         4.  ClearBiTree清空  \t\t\n");
		printf("\t**\t\t5.  BiTreeEmpty判空           6.  BiTreeDepth求深\t\t\n");
		printf("\t**\t\t7.  LocateNode查找            8.  Assign节点赋值 \t\t\t\n");
		printf("\t**\t\t9.  GetSibling兄弟            10. InsertNode插入\t\t\n");
		printf("\t**\t\t11. DeleteNode删除            12. PreOrderTraverse前序\t\t\n");
		printf("\t**\t\t13. InOrderTraverse中序       14. PostOrderTraverse后序\t\t\n");
		printf("\t**\t\t15. LevelOrderTraverse层遍历 \t\t\n");
		printf("\t**\t\t16. MaxPathSum最大路径和\t\t\n");
		printf("\t**\t\t17. LowestCommonAncestor最近公共祖先  \t\t\n");
		printf("\t**\t\t18. InvertTree翻转            19. printTree遍历\t\t\n");
		printf("\t**\t\t20. SaveBiTree存              21. LoadBiTree取\t\t\n");
		printf("\t**\t\t22. Choose多树                0.  Exit退出\t\t\t\n");
