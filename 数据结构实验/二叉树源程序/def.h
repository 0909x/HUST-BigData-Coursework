 ...
 * 函数思路：如果e1和e2分别是T的左右子树的节点，那么T就是他们的最近公共祖先；如果e1和e2都是T的左子树的节点，则在T的左子树中继续寻找他们的最近公共祖先如果e1和e2都是T的右子树的节点， 则在T的右子树中继续寻找他们的最近公共祖先
 */
